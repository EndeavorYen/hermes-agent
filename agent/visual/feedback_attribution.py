...
def record_visual_feedback_for_request(
    ...
    *,
    ...
    artifact_id, method = _select_artifact(parsed.selection_hint, candidates)
    parsed_record = {
        **parsed.parsed,
        "attribution": {
            "method": method,
...
def _select_artifact(selection_hint: int | None, artifact_ids: list[str]) -> tuple[str | None, str]:
