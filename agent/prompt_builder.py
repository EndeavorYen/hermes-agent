...
VISUAL_AGENT_TOOL_GUIDANCE = (
    ...
    "requests, storyboard or multi-shot video requests, or short motion clips. "
    "For image-only requests, use visual agent mode too so Hermes can generate "
    ...
    "For Grok Imagine/xAI requests with reference images, fixed-character "
    "requests, or follow-up image edits, call `visual_agent_generate`; xAI image "
