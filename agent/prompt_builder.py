...
VISUAL_AGENT_TOOL_GUIDANCE = (
    ...
    "`visual_agent_generate`; answer from the latest visual tool result "
    "using the original user prompt, visual-agent rewritten prompt, and actual "
    "image/video generation prompt when available. If the exact prompt is not "
    "available, say that clearly instead of regenerating media. "
