...
def test_render_status_redacts_private_rollout_metadata_values():
    proposal = ActionProposal(
        ...
        metadata={
            "rollout_plan": {
                "status": "pending_approval",
                "verification_commands": [
                    "TOKEN=sk-secret123 pytest /Users/example/private/test.py -q",
                ],
                "promotion_gate": "check /Users/example/private/log.txt",
    ...
    assert "/Users/example/private/test.py" not in output
    assert "/Users/example/private/log.txt" not in output
