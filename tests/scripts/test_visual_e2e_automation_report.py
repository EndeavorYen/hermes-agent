...
def _patch_visual_runtime_environment_ok(monkeypatch, module):
    monkeypatch.setattr(
        module,
        "build_visual_runtime_environment_diagnostic",
        lambda **_kwargs: {"success": True, "next_actions": []},
    )
...
def test_visual_e2e_automation_includes_quality_suite(monkeypatch, tmp_path):
    ...
    _patch_visual_runtime_environment_ok(monkeypatch, visual_e2e_automation_report)
    calls = []
    burn_calls = []
