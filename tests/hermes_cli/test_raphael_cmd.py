...
def test_raphael_proposal_cli_rejects_pending_action_with_audit(
    ...
    args = parser.parse_args(
        [
            ...
            "proposal-1",
            "--reason",
            "Declined sk-secret123 /Users/example/private/trace.json",
        ]
    )
    args.func(args)
    ...
    assert "/Users/example/private/trace.json" not in output
    ...
    assert "/Users/example/private/trace.json" not in event_text
