...
def pre_llm_call(
    ...
    **_: Any,
    ...
    instruction = (
        ...
        "establishing|wide|medium|close_up|macro|insert. Semantic pacing is "
        "5-8 semantic shots per minute, so 30 seconds requires 3-4 shots and five-minute "
        "productions require 25-40. Each normal shot should cover one complete narration thought, "
        "usually one or two complete sentences and about 8-12 seconds of speech. Never split "
