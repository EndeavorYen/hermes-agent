...
def pre_llm_call(
    ...
    **_: Any,
    ...
    if context.phase == "planning":
        ...
        "review_profile_id=family-review-board-v1, and "
        ...
        "and at most two revision rounds. It MUST contain exactly one record for each "
        ...
        "findings instead of six full rewrites; every reviewer status MUST be PASS, "
        "every score MUST be at least 85, and no critical finding may remain unresolved. "
        "The adjudicator writes the only revised full script and records resolved and "
        "unresolved finding IDs. For science, history, documentary, or factual work, "
    ...
    if context.phase == "render":
        ...
        "story-video music library; it must never download random or unlicensed music. "
