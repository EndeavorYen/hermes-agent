...
def _build_responses_payload(*, prompt: str, size: str, quality: str, reference_images: Optional[List[str]] = None) -> Dict[str, Any]:
...
def _collect_image_b64(token: str, *, prompt: str, size: str, quality: str, reference_images: Optional[List[str]] = None) -> Optional[str]:
