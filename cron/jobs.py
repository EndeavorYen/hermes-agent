...
# Required when tick() runs jobs in parallel threads or when multiple CLI/API
# edits touch jobs.json at the same time.
...
def create_job(
    ...
    Args:
        ...
        memory_pipeline: Optional Layer-2 memory-pipeline configuration for audit jobs.
