...
IMAGE_GENERATE_SCHEMA = {
    ...
    "description": (
        ...
        "Routing: if the user asks for a combined visual package with "
        "image and video, image-to-video, stills plus a short clip, or an "
        "assembled visual result, use visual_agent_generate instead of "
        "separate image/video tool calls. This tool is for image-only "
        "requests. "
