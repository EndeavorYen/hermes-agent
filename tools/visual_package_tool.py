...
def _story_video_visual_package_block_payload(error_payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "success": False,
        ...
        "required_image_provider": error_payload.get("required_image_provider")
        or error_payload.get("required_provider"),
        "required_workflow": error_payload.get("required_workflow")
        or "story-video-production-pipeline",
        "generation_strategy": {
