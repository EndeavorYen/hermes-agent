...
- inspect one target session and recent runtime artifacts
- ask Hermes itself for a strict continue/stop decision
- optionally execute exactly one continuation step
...
from agent.reflection import reflection_log_path
...
def _decide_once(goal: str, session_row: Dict[str, Any], args: Namespace) -> Dict[str, Any]:
    ...
    artifacts_dir = Path(reflection_log_path()).parent
