...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rpg", "Show or toggle the RPG-style progression view", "Session",
               cli_only=True, args_hint="[compact|raw|on|off|status]",
               subcommands=("compact", "raw", "on", "off", "status", "help")),
